<script lang="ts">
  ...
  import ImagePlaceholderComp from "$lib/common-library/integrations/components/rich-text/edra-rich-text-extended/shadcn/components/ImagePlaceholder.svelte";
  ...
  import VideoPlaceHolderComp from "$lib/common-library/integrations/components/rich-text/edra-rich-text-extended/shadcn/components/VideoPlaceholder.svelte";
  ...
  import AudioPlaceHolderComp from "$lib/common-library/integrations/components/rich-text/edra-rich-text-extended/shadcn/components/AudioPlaceHolder.svelte";
