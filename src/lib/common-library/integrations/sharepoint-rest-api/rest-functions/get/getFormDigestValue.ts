...
/**
 * Fetch fresh form digest value for POST/UPDATE/DELETE operations
 * Each mutation should get a fresh token - do NOT cache or deduplicate
 */
export async function getFormDigestValue(options?: { siteCollectionUrl?: string; logToConsole?: boolean; signal?: AbortSignal }): Promise<string | Sharepoint_Error_Formatted> {
