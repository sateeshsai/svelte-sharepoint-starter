<script lang="ts">
  ...
  import ImagePlaceholderComp from "$lib/common-library/components/edra-rich-text-sharepoint/shadcn/components/ImagePlaceholder.svelte";
  ...
  import VideoPlaceHolderComp from "$lib/common-library/components/edra-rich-text-sharepoint/shadcn/components/VideoPlaceholder.svelte";
  ...
  import AudioPlaceHolderComp from "$lib/common-library/components/edra-rich-text-sharepoint/shadcn/components/AudioPlaceHolder.svelte";
